  ...
  return (
    <div className="min-h-screen text-white py-12 px-4 sm:px-8 font-menu">
      <div className="max-w-6xl mx-auto space-y-16">
        <h1 className="text-6xl text-center font-bold mb-4">Onze Menu</h1>
        <p className={`text-4xl  text-center mb-12 ${gold}`}>
          Proef onze heerlijke gerechten
        </p>

        <h1 className={`text-4xl text-center mb-12 ${gold}`}>À la Carte</h1>
        <p className="italic text-center text-white mt-6 text-4xl">
            Maximum 4 verschillende voor- en hoofdgerechten per tafel.
          </p>
        {/* STARTERS OM TE DELEN */}
        <section>
          <h2 className={`text-4xl text-center mb-12 ${gold}`}>
            Starters om te delen
          </h2>
        ...
        {/* VOORGERECHTEN */}
        <section>
          <h2 className={`text-4xl text-center mb-12 ${gold}`}>Voorgerechten</h2>
        ...
        {/* HOOFDGERECHTEN */}
        <section>
          <h2 className={`text-4xl text-center mb-12 ${gold}`}>Hoofdgerechten</h2>

          {/* VIS */}
          <h3 className={`text-4xl mt-4 mb-6 text-center ${gold}`}>Vis</h3>
          <ul className="space-y-3">
          ...
          {/* VLEES */}
          <h3 className={`text-4xl mt-10 mb-6 text-center ${gold}`}>Vlees</h3>
          <ul className="space-y-3">
          ...
          {/* WILD */}
          <h3 className={`text-4xl mt-10 mb-6 text-center ${gold}`}>Wild</h3>
          <ul className="space-y-3">
        ...
        {/* VEGETARISCH */}
        <section>
          <h2 className={`text-4xl text-center mb-12 ${gold}`}>Vegetarisch</h2>
          <ul className="space-y-3">
        ...
        {/* SALADES */}
        <section>
          <h2 className={`text-4xl text-center mb-12 ${gold}`}>Salades</h2>
          <ul className="space-y-3">
        ...
        {/* KIDS */}
        <section>
          <h2 className={`text-4xl text-center mb-12 ${gold}`}>Kids</h2>
          <ul className="space-y-3">
        ...
        {/* DESSERTS */}
        <section>
          <h2 className={`text-4xl text-center mb-12 ${gold}`}>Desserts</h2>
          <ul className="space-y-3">
        ...
        {/* MENU ETAPPE 33 */}
        <section>
          <h2 className={`text-4xl text-center mb-12 ${gold}`}>Menu Etappe 33</h2>
          <p className="text-white text-center mb-12 leading-relaxed whitespace-pre-line text-4xl">
          ...
          <p className={`${gold} mt-4 text-center text-4xl`}>
            €59 p.p. / €79 All-In
          </p>
